    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-2">
                        <a href="{{ route('barang-masuk.index') }}" class="btn btn-sm btn-secondary"><i
                                class="fas fa-arrow-left"></i> Barang Masuk</a>
                    </div>
                    @if ($errors->any())
                    ...
                    <form action="{{ route('barang-masuk.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="stock_barang_id" id="stock_barang_id" class="form-control select2">
                                ...
                                @foreach ($stockBarang as $item)
                                    <option value="{{ $item->id }}" {{ $item->id == old('stock_barang_id') ? 'selected' : '' }}>{{ $item->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input"
                                    data-target="#reservationdate" name="tanggal" required value="{{ old('tanggal') }}" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="kuantitas" id="kuantitas" class="form-control"
                                placeholder="Kuantitas" required value="{{ old('kuantitas') }}">
                        </div>
                        <div class="form-group">
